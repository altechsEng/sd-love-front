			...
			{activeSubCat != "account" &&
				<View className='py-4' style={{ flexDirection: "row", justifyContent: "space-between" }}>
					<View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
						...
						<TouchableOpacity onPress={() => navigation.navigate("PostAdd")} style={{ marginLeft: 10, height: 38, width: 38, borderRadius: 100, backgroundColor: "#2E2E2E", alignItems: "center", justifyContent: "center" }}>
					...
					<>
						{allPosts.length > 0 ?
							...
							<View style={{ height: hp("60%"), alignItems: "center", justifyContent: "center" }}>
								...
								<TouchableOpacity className='flex items-center ' onPress={() => navigation.navigate("PostAdd")} style={{ marginTop: 10, width: "80%", paddingVertical: 10, borderRadius: 10, backgroundColor: COLORS.black }}>
