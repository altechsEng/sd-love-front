			...
			>
				...
				<View style={styles.profileImageContainer}>
					...
					<Image
						...
						resizeMode="cover"
						source={{ uri: `${BaseImageUrl}/${item?.avatar}` }}
					/>
				</View>
							...
							<View className={'flex items-center w-full'}>
								<View className={'relative flex flex-row items-center justify-center'}>
									<View className='-mr-4 border-2 border-white' style={{ height: 60, width: 60, borderRadius: 50, overflow: "hidden" }}>
										<Image source={{ uri: `${BaseImageUrl}/${item?.participants[0]?.avatar}` }} style={{ height: "100%", width: "100%" }} />
									</View>
									<Foundation  className='absolute z-10 -mb-20' name="unlink" size={24} color={COLORS.red} />
									<View className='border-2 border-white' style={{ height: 60, width: 60, borderRadius: 50, overflow: "hidden" }}>
										<Image source={{ uri: `${BaseImageUrl}/${item?.participants[1]?.avatar}` }} style={{ height: "100%", width: "100%" }} />
									</View>
								</View>
