			...
			<View style={[
				...
				{item?.message_type == "image" ? (
					<View style={[
						...
						<Image
							source={{ uri: `${BaseChatImageUrl}/public/chat_media/${item?.image}` }}
							resizeMode="cover"
							style={styles.image}
						/>
	...
	return (
		<SafeAreaView className={'flex-1 bg-white'}>
			...
			<View className={'py-3'} style={{ paddingHorizontal: 20, backgroundColor: "white", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
				...
				<TouchableOpacity onPress={() => navigation.navigate("ChatDiscussionOptions", { item })} style={{ height: 40, width: 40, borderRadius: 50, overflow: "hidden" }}>
