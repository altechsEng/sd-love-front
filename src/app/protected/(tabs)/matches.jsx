...
const Matches = ({ navigation }) => {
	...
	const renderProfile = ({ item }) => {
		...
		if (isFetching) {
			return (
				<View style={{ marginTop: 10, borderRadius: 20, overflow: "hidden", backgroundColor: COLORS.light, marginBottom: 10, height: 200, marginRight: 10, flex: 1 }}>
		...
		return (
			<View style={{ marginTop: 10, borderRadius: 20, overflow: "hidden", marginBottom: 10, height: 200, marginRight: 10, flex: 1 }}>
				...
				(
					...
					<View style={{ flex: 1, backgroundColor: "white", padding: 20, alignItems: "center", justifyContent: "center" }}>
						<View style={{ flex: 5, alignItems: "center", justifyContent: "center" }}>
							...
							<CustomRegularPoppingText style={{ width: wp("85%"), marginTop: 5, textAlign: "center" }} value={"We found no match for your profile yet"} fontSize={TEXT_SIZE.medium} color={"gray"} />
						</View>
					</View>
				)
			}
