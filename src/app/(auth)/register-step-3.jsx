...
export default function RegisterStepThree({ navigation }) {
	...
	useEffect(() => {
		...
		return console.log(questionnaireData);
	...
	const renderHobies = ({ item }) => {
		...
		return (
			<TouchableOpacity onPress={() => setActiveInterest(item)} style={{ flexGrow: 2, marginRight: 5, marginBottom: 5, backgroundColor: "#F5F6FC", paddingVertical: 2, paddingHorizontal: 10, borderRadius: 10, alignItems: "center", justifyContent: "center", flexDirection: "row", borderWidth: 2, borderColor: activeInterest == item ? "#FF5656" : "#F5F6FC" }}>
	...
	return (
		<View>
			<Stack.Screen options={{
				header: ({ navigation }) => (
					<QuestionaireHeader navigation={navigation} title={"1/2 Questions générales"} description={"Dites-nous en peu sur vous"} />
				)
			}} />
			<ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ backgroundColor: "white" }}>
				...
				<View style={{ height: 50, paddingHorizontal: 20 }}>
					<TouchableOpacity onPress={() => router.navigate("register-step-4")} style={{ borderRadius: 10, alignItems: 'center', justifyContent: "center", backgroundColor: COLORS.primary, paddingVertical: 10, paddingHorizontal: 20 }}>
