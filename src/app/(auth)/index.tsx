	...
	return (
		<View className={'flex-1 bg-white'}>
			...
			<View className={'relative -top-[60px] flex-2 items-center'}>
				...
				<TouchableOpacity onPress={() => router.navigate("/login")} style={{ backgroundColor: COLORS.primary, paddingVertical: 15, marginVertical: 20, paddingHorizontal: 20, width: "80%", borderRadius: 100 }}>
					<Text style={{ color: "white", textAlign: "center", fontFamily: FAMILLY.regular }} >Sign In</Text>
				</TouchableOpacity>

				<TouchableOpacity onPress={() => router.navigate("/register-step-1")} style={{ backgroundColor: "transparent", paddingVertical: 10, paddingHorizontal: 20, width: "80%", borderRadius: 100 }}>
