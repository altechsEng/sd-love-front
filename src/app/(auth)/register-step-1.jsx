...
export default function RegisterStepOne({ navigation }) {
	...
	const handleData = () => {
		...
		router.navigate("register-step-2")
	}
	...
	return (
		...
		<View className={'flex-1 bg-white'}>
			...
			<View className={'flex-1'} style={{ alignItems: "center", flexDirection: "row", justifyContent: "center", position: "relative" }}>
				...
				<View style={{ position: "absolute", right: -10, height: 5, width: "50%", backgroundColor: COLORS.primary }}></View>
				<View style={{ position: "absolute", right: -25, borderRadius: 50, height: 50, width: 50, backgroundColor: COLORS.primary, alignItems: "center", justifyContent: "center" }}></View>
			...
			<View className={''} style={{ alignItems: "center", flex: 3, height: 500 }}>
				...
				<View style={{ marginTop: 10, paddingHorizontal: wp(10), flexDirection: "row", alignItems: "Center" }}>
					<TouchableOpacity onPress={() => setVisible(true)} style={{ flex: 1, borderRadius: 50, backgroundColor: "rgba(181, 181, 181, 0.12)", flexDirection: "row", alignItems: "center", justifyContent: "center", paddingHorizontal: 15 }}>
						<View>
				...
				<View style={{ flex: 3, height: hp(5), justifyContent: "flex-end" }}>
					<View className={'pb-8'} style={{ alignItems: "center", justifyContent: "center", flexDirection: "row" }}>
						...
						<TouchableOpacity style={{ marginTop: 1 }} onPress={() => router.navigate("login")}>
