...
export const QuestionaireHeader = ({ navigation, title, description }) => {
		...
		<View style={{ height: 80, backgroundColor: "white" }}>
			...
			<View style={{ backgroundColor: "white", alignItems: "center", justifyContent: "space-between", flexDirection: "row", padding: 10 }}>
				...
				<View style={{ alignItems: "center", justifyContent: "center" }}>
					<Text style={{ color: '#808A94', fontFamily: FAMILLY.semibold, fontSize: TEXT_SIZE.small }}>{title}</Text>
					<Text style={{ color: COLORS.black, fontFamily: FAMILLY.semibold, fontSize: TEXT_SIZE.secondary }}>{description}</Text>
				</View>
