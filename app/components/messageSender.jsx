...
const MessageSender = ({action,state,setState,placeHolder}) => {
     return <View style={{height:50,paddingHorizontal:2,alignItems:"center",justifyContent:"space-evenly",flexDirection:"row"}}>
     <TouchableOpacity> 
          <PostScreenImagePicker/> 
     </TouchableOpacity>
     <View style={{position:"relative",borderRadius:50,paddingVertical:5,paddingHorizontal:36,width:"80%", backgroundColor:"rgba(181, 181, 181, 0.12)"}}>
     <CustomTextInput RightIconStyles={null} name="comment" placeHolder={placeHolder} LeftIcon={"face"} LeftIconStyles={{position:"absolute",top:5,left:15}} RightIcon={null} setState={setState} state={state}/>
     </View>
