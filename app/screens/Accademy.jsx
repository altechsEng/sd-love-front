    ...
    return (
        <View style={{ flex: 1, backgroundColor: "white", padding: 20, alignItems: "center", justifyContent: "center" }}>
            ...
            <View style={{ flex: 5, alignItems: "center", justifyContent: "center" }}>
                ...
                <CustomRegularPoppingText style={{ width: wp("85%"), marginTop: 5, textAlign: "center" }} value={"This module is corrently under contruction"} fontSize={TEXT_SIZE.primary} color={"gray"} />
