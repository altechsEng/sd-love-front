		...
		<View className='flex-1 bg-white'>
			...
			>
				...
				<View style={styles.postActions}>
					<View className='gap-3' style={{ flexDirection: "row", justifyContent: "space-between" }}>
						<View className='gap-1' style={styles.postActionItem}>
							<TouchableOpacity onPress={() => handleLikePost()}>
								{isitemLiked ? <HomeFeedHeart stroke={COLORS.primary} fill={COLORS.primary} /> : <HomeFeedHeart stroke={"gray"} fill={"white"} />}
							</TouchableOpacity>
						...
						<View className='gap-1' style={styles.postActionItem}>
							<TouchableOpacity onPress={() => setShowComment(!showComment)}>
								<HomeFeedComment stroke={"gray"} fill={"white"} />
							</TouchableOpacity>
							<Text style={styles.postActionCount}>{comments.length}</Text>
						</View>

						<View className='gap-2' style={styles.postActionItem}>
							<TouchableOpacity>
								<HomeFeedShare fill={"gray"} />
							</TouchableOpacity>
