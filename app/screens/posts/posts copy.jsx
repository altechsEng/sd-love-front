	...
	return (
		<ScrollView style={{ backgroundColor: "white" }}>
			<View style={{ backgroundColor: "white", flex: 1 }}>
				...
				<View className='flex-1' style={{ height: SCREEN_HEIGHT * 0.35, borderBottomWidth: 2, borderColor: COLORS.light, alignItems: "center", justifyContent: "center", flexDirection: "column" }}>
				...
				<MessageSender className='fixed' placeHolder={"Add a comment"} action={() => null} state={comment} setState={setComment} />
