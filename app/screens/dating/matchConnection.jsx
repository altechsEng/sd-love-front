...
export default function MatchConnection({navigation}) {
     ...
     return (
          ...
          <CustomSemiBoldPoppingText style={{textAlign:"center",marginVertical:20}} color="#D0917B" fontSize={TEXT_SIZE.title+8} value="89%"/>
         ...
         <Image source={require('../../../assets/images/match_con1.jpg.jpg')} style={{borderRadius:20,width:"100%",height:"100%"}} resizeMode='cover'/>
         </View>
         ...
         <Image source={require('../../../assets/images/test_match1.jpg')} style={{borderRadius:20,width:"100%",height:"100%"}} resizeMode='cover'/>
         </View>
          </View>
          ...
          <View style={{alignItems:"center",width:"80%",justifyContent:"center",marginTop:50}}>
               <CustomSemiBoldPoppingText style={''} value="It is a match, steve!" color="black" fontSize={TEXT_SIZE.title}/>
               <CustomRegularPoppingText style={{textAlign:"center",width:"80%",margin:"auto"}} value="You and Jane have matched, start a conversation with each other now." color="#5E5E5E" fontSize={TEXT_SIZE.small}/>
          </View>

     
          <TouchableOpacity style={{marginTop:60,width:"80%",paddingVertical:10,borderRadius:20,backgroundColor:COLORS.primary}}>
                    <CustomRegularPoppingText fontSize={TEXT_SIZE.small+2} value="Connect with Maggy" style={{textAlign:"center"}} color={"white"}/>
               </TouchableOpacity>

               <TouchableOpacity onPress={() => navigation.navigate("MatchProfile")} style={{marginTop:10,width:"80%",paddingVertical:10,borderRadius:20,backgroundColor:"rgba(215, 168, 152, 0.13)"}}>
